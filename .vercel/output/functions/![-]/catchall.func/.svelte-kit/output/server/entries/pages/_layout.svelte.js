import { R as getContext, S as store_get, T as unsubscribe_stores, Q as pop, O as push } from "../../chunks/index2.js";
...
function _layout($$payload, $$props) {
  ...
  children($$payload);
  $$payload.out += `<!----></main> <footer class="svelte-8o1gnw"><p><a href="/privacy-policy" class="svelte-8o1gnw">Privacy Policy</a></p></footer></div>`;
  pop();
}
export {
  _layout as default
